...
word_classes = [
    ...
    'rat', 'weasel', 'wolverine', 'animal', 'beaver', 'backpack', 'umbrella', 'tie', 'hat', 'sunglasses', 'shirt',
    ...
    'mandarin', 'cucumber', 'tomato', 'chickpea', 'broccoli', 'brussel sprout', 'carrot', 'corn', 'garlic', 'onion',
