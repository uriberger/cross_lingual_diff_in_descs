...
def water_handling(token_list, start_ind):
    ...
    if start_ind < len(token_list) - 1 and token_list[start_ind + 1][0]['text'] in ['bottle', 'glass', 'bottles', 'glasses', 'cup', 'cups']:
        return [('water.n.06', 0)]
    ...
    if start_ind > 0 and token_list[start_ind - 1][0]['text'] in ['clear', 'shallow', 'greenish', 'bluish', 'blue', 'sea', 'open']:
        return [('body_of_water.n.01', 0)]
